...
TestScene::TestScene()
{
  auto tex = ImageHandler::GetInstance().LoadFromFile("input_data/test.png", true);
  ...
  AddFloorXY_zUp(150, 84.375, Vector3(50, 40.8, 0), Material(Material::REFLECTION_TYPE_LAMBERT, Color(), Color(1, 1, 1), 0.0, tex));  // 奥
  //AddObject(new Sphere(1e5, Vector3(50, 40.8, -1e5 + 250), Material(Material::REFLECTION_TYPE_LAMBERT, Color(), Color())), true, false);                  // 手前
  AddFloorXY_zDown(100, 100, Vector3(50, 40.8, 250), Material(Material::REFLECTION_TYPE_LAMBERT, Color(), Color(0.75, 0.75, 0.75), 0.0, tex));  // 手前
